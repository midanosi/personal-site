...
var manifest = {
  ...
  routes: [
    ...
    {
      type: "page",
      pattern: /^\/codesandboxes\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/codesandboxes.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/codesandboxes.svelte": () => Promise.resolve().then(function() {
    return codesandboxes;
  }),
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"svelte-uprcm8"}"><div class="${"corner svelte-uprcm8"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-uprcm8"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-uprcm8"}"></a></div>
	<nav class="${"svelte-uprcm8"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-uprcm8"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-uprcm8"}"></path></svg>
		<ul class="${"svelte-uprcm8"}"><li class="${["svelte-uprcm8", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-uprcm8"}">Home</a></li>
			<li class="${["svelte-uprcm8", $page.path === "/about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/about"}" class="${"svelte-uprcm8"}">About</a></li>
			<li class="${["svelte-uprcm8", $page.path === "/blog" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/blog"}" class="${"svelte-uprcm8"}">Blog</a></li>
			<li class="${["svelte-uprcm8", $page.path === "/codesandboxes" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/codesandboxes"}" class="${"svelte-uprcm8"}">CodeSandboxes</a></li></ul>
		<svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-uprcm8"}"><path d="${"M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z"}" class="${"svelte-uprcm8"}"></path></svg></nav>
	<div class="${"corner svelte-uprcm8"}"></div></header>`;
});
...
<main class="${"svelte-dzpi70"}">${validate_component(PageTransition, "PageTransition").$$render($$result, { refresh: key }, {}, {
    default: () => `${slots.default ? slots.default({}) : ``}`
  })}</main>
<footer class="${"svelte-dzpi70"}"><p>visit <a href="${"https://kit.svelte.dev"}" class="${"svelte-dzpi70"}">kit.svelte.dev</a> to learn SvelteKit</p></footer>`;
});
...
var MarkdownExample_svelte = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { count = 21 } = $$props;
  if ($$props.count === void 0 && $$bindings.count && count !== void 0)
    $$bindings.count(count);
  return `<p>This is an example of an mdsvex component.</p>
<p>You can import it as $lib/Example.svelte.md. Just delete this file if you don\u2019t care.</p>
<p>By the way, the count is ${escape2(count)}.</p>`;
});
var css$1 = {
  code: "section.svelte-1pu6b31{display:flex;flex-direction:column;justify-content:center;align-items:center;flex:1}h1.svelte-1pu6b31{color:#ff3e00;text-transform:uppercase;font-size:4rem;font-weight:100;line-height:1.1;margin:4rem auto;max-width:14rem}p.svelte-1pu6b31{max-width:14rem;margin:2rem auto;line-height:1.35}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\texport const prerender = true;\\n\\n<\/script>\\n<script>\\n\\timport MarkdownExample from '$lib/MarkdownExample.svelte.md';\\n\\n<\/script>\\n<style>\\n\\tsection {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t\\tflex: 1;\\n\\t}\\n\\n\\th1 {\\n\\t\\tcolor: #ff3e00;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-size: 4rem;\\n\\t\\tfont-weight: 100;\\n\\t\\tline-height: 1.1;\\n\\t\\tmargin: 4rem auto;\\n\\t\\tmax-width: 14rem;\\n\\t}\\n\\n\\tp {\\n\\t\\tmax-width: 14rem;\\n\\t\\tmargin: 2rem auto;\\n\\t\\tline-height: 1.35;\\n\\t}\\n\\n</style>\\n<svelte:head>\\n\\t<title>Home</title>\\n</svelte:head>\\n\\n\\n<section>\\n\\t<h1>Michael Hutchings</h1>\\n\\t<i>site wip</i>\\n\\t<p>Hi, I'm a front-end web developer based in Cambridge!</p>\\n\\t<article>\\n\\t\\t<h2>Portfolio</h2>\\n\\t\\t<h4>Non-ZZMT site</h4>\\n\\t</article>\\n\\t<article>\\n\\t\\t<h2>Old projects</h2>\\n\\t\\t<h4>\\n\\t\\t\\tNon-ZZMT site (please don't judge (note to self: put tags here like 'php', 'mysql' etc. to\\n\\t\\t\\tindicate technologies used)\\n\\t\\t</h4>\\n\\t\\t<h4>MKSC Videos</h4>\\n\\t</article>\\n\\t<MarkdownExample />\\n</section>\\n\\n"],"names":[],"mappings":"AASC,OAAO,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,IAAI,CAAE,CAAC,AACR,CAAC,AAED,EAAE,eAAC,CAAC,AACH,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,SAAS,CAAE,KAAK,AACjB,CAAC,AAED,CAAC,eAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,WAAW,CAAE,IAAI,AAClB,CAAC"}`
};
...
<section class="${"svelte-1pu6b31"}"><h1 class="${"svelte-1pu6b31"}">Michael Hutchings</h1>
	<i>site wip</i>
	<p class="${"svelte-1pu6b31"}">Hi, I&#39;m a front-end web developer based in Cambridge!</p>
	<article><h2>Portfolio</h2>
		<h4>Non-ZZMT site</h4></article>
	<article><h2>Old projects</h2>
		<h4>Non-ZZMT site (please don&#39;t judge (note to self: put tags here like &#39;php&#39;, &#39;mysql&#39; etc. to
			indicate technologies used)
		</h4>
		<h4>MKSC Videos</h4></article>
	${validate_component(MarkdownExample_svelte, "MarkdownExample").$$render($$result, {}, {}, {})}</section>`;
});
...
var Codesandboxes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { stuff = 3 } = $$props;
  if ($$props.stuff === void 0 && $$bindings.stuff && stuff !== void 0)
    $$bindings.stuff(stuff);
  return `<span>Codesandboxes yay! ${escape2(stuff)}</span>`;
});
var codesandboxes = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Codesandboxes
});
var browser = false;
var dev = false;
var css = {
  code: ".content.svelte-1x0xzh8{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}",
  map: `{"version":3,"file":"about.svelte","sources":["about.svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\timport { browser, dev } from '$app/env';\\n\\n\\t// we don't need any JS on this page, though we'll load\\n\\t// it in dev so that we get hot module replacement...\\n\\texport const hydrate = dev;\\n\\n\\t// ...but if the client-side router is already loaded\\n\\t// (i.e. we came here from elsewhere in the app), use it\\n\\texport const router = browser;\\n\\n\\t// since there's no dynamic data here, we can prerender\\n\\t// it so that it gets served as a static asset in prod\\n\\texport const prerender = true;\\n\\n<\/script>\\n<style>\\n\\t.content {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: var(--column-width);\\n\\t\\tmargin: var(--column-margin-top) auto 0 auto;\\n\\t}\\n\\n</style>\\n<svelte:head>\\n\\t<title>About</title>\\n</svelte:head>\\n\\n\\n<div class=\\"content\\">\\n\\t<h1>About this app</h1>\\n\\t<p>\\n\\t\\tThis is a <a href=\\"https://kit.svelte.dev\\">SvelteKit</a> app. You can make your own by typing the\\n\\t\\tfollowing into your command line and following the prompts:\\n\\t</p>\\n\\t<!-- TODO lose the @next! -->\\n\\t<pre>npm init svelte@next</pre>\\n\\t<p>\\n\\t\\tThe page you're looking at is purely static HTML, with no client-side interactivity needed.\\n\\t\\tBecause of that, we don't need to load any JavaScript. Try viewing the page's source, or opening\\n\\t\\tthe devtools network panel and reloading.\\n\\t</p>\\n</div>\\n\\n"],"names":[],"mappings":"AAiBC,QAAQ,eAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,cAAc,CAAC,CAC9B,MAAM,CAAE,IAAI,mBAAmB,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,AAC7C,CAAC"}`
};
var hydrate = dev;
var router = browser;
var prerender = true;
...
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  id = $page.params.id;
  $$unsubscribe_page();
  return `<span>current page is ${escape2(id)}</span>`;
});
